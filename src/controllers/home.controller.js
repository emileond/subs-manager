...
export default () => {
    ...
    const main = divEl.querySelector('.subscriptions');
    const subsListActive = divEl.querySelector('.subscriptions--list');
    const subsListInactive = divEl.querySelector('.subscriptions--list__inactive')
    const totalContainer = divEl.querySelector('.total')
